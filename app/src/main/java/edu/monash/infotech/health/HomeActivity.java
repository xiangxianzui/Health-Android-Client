...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Calendar.getInstance().get(Calendar.AM_PM) == 0){
            Welcome_TextView.setText("Good Morning " + username + "!");
        }
        if(Calendar.getInstance().get(Calendar.AM_PM) == 1){
            Welcome_TextView.setText("Good Afternoon " + username + "!");
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_calorieGoal) {
            Intent intent = new Intent(this, CaloriegoalActivity.class);
            intent.putExtra("username", username);
            startActivity(intent);
        } else if (id == R.id.nav_dailyDiet) {
            Intent intent = new Intent(this, DailyDietActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_steps) {
            Intent intent = new Intent(this, StepsActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_trackCalorie) {
            Intent intent = new Intent(this, TrackCalorieActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_progressReport) {
            ...
            intent.putExtra(Intent.EXTRA_TEXT, "Breath with your heart.");
